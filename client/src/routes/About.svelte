<main id="about">
	...
	<div id="contributors">
		<h3>Contributors:</h3>
		<p>
			<a href="https://github.com/leomet07/" target="_blank"
				>Lenny M (@leomet07)</a
			>
		</p>
		<p>
			<a href="https://github.com/TheEgghead27" target="_blank"
				>David C (@TheEgghead27)</a
			>
		</p>
		<p>
			<a href="https://github.com/thegu5" target="_blank"
				>Gus W (@thegu5)</a
			>
		</p>
	</div>
